...
public final class Canvas {
    ...
    public Canvas(final int height, final int width) {
    ...
    public void fludFill(final int x, final int y,
        ...
        class Fludder {
            ...
            Fludder(final int x, final int y,
                    final int edgeColorP, final int fillColorP,
                    final Canvas canvasP) {
        ...
        Fludder fludder = new Fludder(x, y, edgeColor, fillColor, this);
        fludder.flud();
    }
