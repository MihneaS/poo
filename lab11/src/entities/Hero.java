...
public abstract class Hero {
    ...
    public void attack() {
        if (canAttack()) {
            if (getHP() < 50) {
                AttackStrategy attackStrategy = new AttackStrategy(this);
                attackStrategy.attack(target);
            } else {
                DefenseStrategy defenseStrategy = new DefenseStrategy(this);
                defenseStrategy.attack(target);
            }
        }
